          ...
          <form onSubmit={handleSubmit}>
            <ScrollArea className="h-[65vh] pr-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                ...
                <div className="md:col-span-2 bg-gradient-to-r from-purple-50 via-blue-50 to-purple-50 border-2 border-purple-200 rounded-lg p-4 shadow-sm">
                  <div className="flex items-center gap-2 mb-3">
                    <Sparkles className="h-5 w-5 text-purple-600 animate-pulse" />
                    <h3 className="font-semibold text-purple-900">✨ AI Document Extraction</h3>
                  </div>
                  <p className="text-sm text-purple-700 mb-3">
                    Upload a work order, docket, or invoice and let AI fill the form automatically!
                  </p>
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            setExtractedDocumentUrl(file_url);

                            const result = await extractJobDataWithGemini({ file_url });
                            ...
                            if (result.status === 'success' && result.data) {
                              ...
                              if (extracted.deliveryLocation) updates.deliveryLocation = extracted.deliveryLocation;
                              ...
                              toast({
                                ...
                                description: "Review the pre-filled information below.",
                              });
                            } else {
                            ...
                            toast({
                              ...
                              description: error.message || "Could not extract data. Please fill manually.",
                              variant: "destructive",
                            });
                          } finally {
                            setExtracting(false);
                      ...
                      {extractedData && (
                        <div className="flex items-start gap-2 p-2 bg-green-50 border border-green-200 rounded-lg">
                          ...
                          <div className="text-xs text-green-700">
                            <strong>Success!</strong> Review the fields below.
                          </div>
                        </div>
                      )}
                    </div>
            ...
            <DialogFooter className="pt-4">
              ...
              <Button type="submit" disabled={loading || uploadingAttachment || extracting}>
